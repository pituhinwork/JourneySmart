...
export default class ContextMenu extends React.Component {
  ...
  computePositionAndSize(layouts) {
     return computePosition(layouts);
  }
  ...
  render() {
    ...
    const positionAndSize = this.computePositionAndSize(layouts);
    return (
      <Animated.View {...other} style={[styles.
         options, style, animation, positionAndSize]}>
        {children}
      </Animated.View>
    );
  }
